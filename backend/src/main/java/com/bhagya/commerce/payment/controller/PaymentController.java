...
@Tag(name = "Payments", description = "Authoritative Gateway Sessions, Verification, Refunds & Webhooks")
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentSessionResponse>> createSession(
        ...
        return ResponseEntity.ok(ApiResponse.success(session, "Payment session initialized"));
    }
    ...
    @Operation(summary = "Initiate payment refund (Idempotent)")
    public ResponseEntity<ApiResponse<RefundResponse>> refundPayment(
        ...
        RefundResponse response = paymentService.refundPayment(paymentId, request, principal.getId(), idempotencyKey);
